...
<body class="easyui-layout">
	...
	<div id="layoutMenu" data-options="region:'west',title:'主菜单',href:'__APP__/Layout/west'" style="width:210px;overflow: hidden;"></div>
	...
	<div data-options="region:'south',border:false,href:'__APP__/Public/south'" style="height: 27px;overflow: hidden;"></div>-->
</body>
</html>